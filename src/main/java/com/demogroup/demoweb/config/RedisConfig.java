...
//        EventLoopGroupProvider eventLoopGroupProvider = DefaultEventLoopGroupProvider.builder().build();
//        DefaultClientResources clientResources = DefaultClientResources.builder()
//                .eventLoopProvider(eventLoopGroupProvider)
//                .build();
...
//                        if (uri.getHost().equals("10.42.11.73")) {
//                            return new RedisURI(uri.getScheme(), "213.8.76.4", uri.getPort());
//                        }
//                        return uri;
//                    }
//                });
//
//        // Redis Connection Factory with Sentinel Configuration
//        LettuceConnectionFactory lettuceConnectionFactory = new LettuceConnectionFactory(redisUri);
//        lettuceConnectionFactory.setClientResources(clientResources);
//        lettuceConnectionFactory.setClientConfiguration(clientConfig);
//
