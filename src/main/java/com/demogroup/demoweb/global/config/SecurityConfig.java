package com.demogroup.demoweb.global.config;

import com.demogroup.demoweb.global.auth.filter.JWTExceptionFilter;
import com.demogroup.demoweb.global.auth.filter.JWTFilter;
import com.demogroup.demoweb.global.auth.filter.LoginFilter;
import com.demogroup.demoweb.global.auth.handler.CustomAuthenticationFailureHandler;
import com.demogroup.demoweb.global.auth.handler.CustomOAuth2LoginFailureHandler;
import com.demogroup.demoweb.global.auth.handler.CustomOAuth2LoginSuccessHandler;
import com.demogroup.demoweb.global.auth.handler.JWTAuthenticationEntryPoint;
import com.demogroup.demoweb.domain.user.repository.UserRepository;
import com.demogroup.demoweb.global.oauth.CustomOAuth2UserService;
...
//                )
                ...
                */
                .addFilterAt(new LoginFilter(authenticationManager(authenticationConfiguration),new CustomAuthenticationFailureHandler(), jwtUtils)
