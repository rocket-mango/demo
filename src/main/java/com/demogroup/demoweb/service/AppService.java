...
public class AppService {
    ...
    public Weather getWeather() throws Exception{
        ...
        * 이후 sb에 저장한 내용을 문자열 result에 저장합니다.
        ...
        Weather response = weatherJson(result);

        return response;
    }

    private Weather weatherJson(String result) {
        ...
        try {
            ...
            Weather weather=new Weather(humidity,precipitation,temperature,wind, wind_velocity);
            return weather;
